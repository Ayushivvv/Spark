    ...
    <div className="flex flex-col items-center px-8 pt-20 pb-10 min-h-screen">
      ...
      <div className="w-full space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-500">Enter your email and password to sign up for this app</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500">
          Already have an account? <Link to="/signin" className="text-black font-semibold underline">Sign In</Link>
        </p>
        ...
        <p className="text-center text-[10px] text-gray-400 px-4 pt-6">
